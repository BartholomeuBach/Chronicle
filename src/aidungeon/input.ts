...
const modifier = (value: string) => ({
  text: globalThis.ChronicleAIDungeon?.onInput(value, { state, actionCount: info.actionCount, storyCards: { storyCards, addStoryCard, updateStoryCard, removeStoryCard: typeof removeStoryCard === "function" ? removeStoryCard : undefined } }) ?? nonEmptyText(value)
});
