...
const modifier = (value: string) => ({
  text: globalThis.ChronicleAIDungeon?.onContext(value, { state, actionCount: info.actionCount, storyCards: { storyCards, addStoryCard, updateStoryCard } }) ?? nonEmptyText(value)
});
